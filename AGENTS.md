...
- Start with [`docs/artifact-map.md`](docs/artifact-map.md), [`planning/status.md`](planning/status.md), [`planning/plan.md`](planning/plan.md), and [`planning/phase-work-orders.md`](planning/phase-work-orders.md). Use [`spec/product-app-v1.md`](spec/product-app-v1.md) for the current UI, [`spec/series-accounting.md`](spec/series-accounting.md) and [`spec/sdk-interface.md`](spec/sdk-interface.md) for accounting boundaries, and [`apps/web/qa/README.md`](apps/web/qa/README.md) for detailed verification.
