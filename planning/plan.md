...
Keep observation and execution distinct. **Observation** presents real Solana mint and issuer records; cached responses say snapshot rather than live. The current **local rehearsal** uses sourced historical events, in-memory balances and demo receipts. It resets on refresh and performs no onchain transactions. The later **historical program replay** will execute those events through the DivX program on test collateral, with original and replay clocks stored separately. A seeded sale price is demo market data, never an observed historical DR price.
...
The [official hackathon page](https://hackathons.solana.com/hackathons/stocklana), rechecked 20 September, now gives September 25 at 4 p.m. Eastern in its written timeline (September 26 at 04:00 Asia/Makassar). This supersedes the older inconsistent September 18 text. The public instructions require at least one GitHub, live-demo or video link; slides and a three-minute video are our proposed package, not assumed mandatory fields. Use the [submission packet](hackathon-wrap-up-2026-09-20.md), [mainnet readiness gates](mainnet-readiness-2026-09-20.md) and [outreach shortlist](ecosystem-outreach-2026-09-20.md) for wrap-up. Exact signed-in fields still require inspection. No submission or outreach has occurred.
