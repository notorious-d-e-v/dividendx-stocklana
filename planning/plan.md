...
17 September implementation update: the annual program, transaction SDK and real local wallet flow are accepted; see [program verification](program-review.md) and [wallet acceptance](wallet-review.md). [Program v1](../spec/program-v1.md) resolves the account, authority, bounded arithmetic and staged-finalization contract. Rolling vaults, earlier next-year listings, quarterly terms and perpetual-product research are recorded in the [roadmap](roadmap.md), outside this phase.
