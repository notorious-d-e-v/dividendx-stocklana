...
| Guided DeFi demos — in progress | Separate `/demos/`: two local test wallets execute Raydium liquidity and purchases, paired exit and independent redemption; keep core `/app/` Split/Redeem intact | High |
