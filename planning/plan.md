...
| Issuer qualification and settlement — current priority | Offline unsigned review is accepted; resolve event/ex-date/factor joins, custody and revision/coverage policy before any settlement writer | High |
