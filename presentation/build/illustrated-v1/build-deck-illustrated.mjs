...
const FINAL_PPTX = path.join(workspaceDir, "output", "DivX-illustrated-v1.pptx");
...
const candidatePath=path.join(stagingDir,"DivX-illustrated-v1-candidate.pptx");
...
const result=await finalizePresentation({
 ...
 receiptPath:path.join(stagingDir,"DivX-illustrated-v1.validation.json")
});
