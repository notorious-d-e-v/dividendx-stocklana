...
const FINAL_PPTX = path.join(workspaceDir, "output", "DivX-phase-two-v3.pptx");
...
const result=await finalizePresentation({
 ...
 receiptPath:path.join(stagingDir,"DivX-phase-two-v3.validation.json")
});
