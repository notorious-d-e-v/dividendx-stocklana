...
const FINAL_PPTX = path.join(workspaceDir, "output", "DividendX-phase-two-v2.pptx");
...
// 7 — Corporate actions
{
 ...
 label(s,"Issuer event",80,194,340); label(s,"DividendX treatment",455,194,700); rule(s,80,225,1090,C.ink,2);
...
const result=await finalizePresentation({
 ...
 receiptPath:path.join(stagingDir,"DividendX-phase-two-v2.validation.json")
});
