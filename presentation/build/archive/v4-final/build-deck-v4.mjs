...
const FINAL_PPTX = path.join(workspaceDir, "output", "DivX-phase-two-v4.pptx");
...
// 1 — Cover
{
 ...
 notes(s,"DivX lets a stock holder keep the stock exposure and sell the dividend rights. We are building a shared dividend market for tokenized stocks on Solana, with xStocks, Backpack and Ondo in the initial integration scope.",["The protocol is not launched. Current software is an approved interface and working historical calculator. Initial integration scope does not mean every token from these issuers is eligible or already integrated."],[]);
}
...
const result=await finalizePresentation({
 ...
 receiptPath:path.join(stagingDir,"DivX-phase-two-v4.validation.json")
});
