...
const FINAL_PPTX = path.join(workspaceDir, "output", "DividendX-phase-two-v5.pptx");
...
// 3 — Mechanism
{
 ...
 const asset=box(s,78,284,190,100,C.ink,C.ink,14,"Stock token"); text(s,"Stock token",96,307,154,50,26,"#FFFFFF",true,{align:"center",valign:"middle"});
 ...
 text(s,"Each pair of claims has its own locked collateral.",78,578,770,38,23,C.ink,true);
 text(s,"Redeems in the deposited stock token. Dollar value can change.",78,626,810,30,17,C.muted,false);
...
// 6 — One workflow across issuers
{
 ...
 const rows=[
  ...
  ["02","Atomic issuance","Deposit collateral and issue both claims together.",C.ink],
...
const result=await finalizePresentation({
 ...
 receiptPath:path.join(stagingDir,"DividendX-phase-two-v5.validation.json")
});
