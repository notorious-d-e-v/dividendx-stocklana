...
const FINAL_PPTX = path.join(workspaceDir, "output", "DivX-illustrated-v2.pptx");
...
const candidatePath=path.join(stagingDir,"DivX-illustrated-v2-candidate.pptx");
...
const result=await finalizePresentation({
 ...
 receiptPath:path.join(stagingDir,"DivX-illustrated-v2.validation.json")
});
