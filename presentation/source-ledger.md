...
- [Solana transactions](https://solana.com/docs/core/transactions) supports placing payment and claim transfer together in one transaction. This is DivX’s intended trade design; it has not yet been implemented or executed.
